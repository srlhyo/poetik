...
function devduo_register_styles() {
    ...
    wp_register_style('devduo_style', get_template_directory_uri() . '/src/app.css' , array(), false, 'all');
...
function devduo_register_scripts() {
    ...
    wp_register_script('devduo_script', get_template_directory_uri() . '/src/app.js' , array('jquery'), false, true);
